...
const infoData = [
  {
    title: 'Misión',
    description:
      'Garantizar nuestros productos con estrategias de acuerdo a las necesidades específicas de nuestros clientes, demostrando calidad, confiabilidad, tranquilidad y responsabilidad.',
    image: '/images/info_card/mission.webp',
  },
  {
    title: 'Visión',
    description:
      'Convertir a nuestra empresa en un valor agregado para la productividad y éxito de nuestros clientes, proporcionando productos de alta calidad.',
    image: '/images/info_card/vision.webp',
  },
  {
    title: 'Valores',
    description:
      'Compromiso con precisión, mejora continua, competitividad innovadora, integridad en acciones y fomento del respeto y trabajo en equipo.',
