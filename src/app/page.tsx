    ...
    <main className="flex flex-col items-center">
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          <ProductButton href="/antiestaticas" title="Antiestáticas" bgImage="/images/product_card/antistatic.webp" />
          <ProductButton href="/alimentos" title="Para Alimentos" bgImage="/images/product_card/food.webp" />
          <ProductButton
            href="/impresion"
