    ...
    <footer className="flex flex-col w-full bg-spgradient text-spwhite p-5 pb-28 gap-10 z-[2]">
      <div className="flex flex-col w-full gap-4">
        ...
        <div className="flex flex-col w-fit gap-3">
          ...
          <Link href={'https://www.facebook.com/sumiplas.mx/'} className="flex items-center gap-1.5">
            <svg width="24" height="24" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <Link href={'https://www.instagram.com/sumiplas.mx/'} className="flex items-center gap-1.5">
